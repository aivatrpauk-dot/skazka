...
BOT_SHORT_DESCRIPTION = (
    ...
    "Имя, герой, тема — и готовая PDF-книжка с иллюстрациями и музыкой."
)
...
BOT_DESCRIPTION = (
    "🌙 «Сказка» — место, где для Вашего ребёнка 3–6 лет каждый вечер "
    "сочиняется своя, особенная сказка.\n\n"
    "Имя, любимый герой, тема — и через пару минут готовая "
    "PDF-книжечка с тремя авторскими иллюстрациями и фоновая мелодия "
    "для чтения вслух.\n\n"
    "👩‍👧 Читаете Вы — самым тёплым голосом в мире. Мы лишь "
    "помогаем создать атмосферу.\n\n"
    "Одна сказка вечером — и спокойный сон. Таков наш ритуал.\n\n"
