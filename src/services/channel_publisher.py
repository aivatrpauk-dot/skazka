...
#
# Позиционирование осознанное: не «герой носил имя» (звучит как подстановка
# в шаблон, занижает продукт), а «персональная сказка под ребёнка» (другой
# уровень: уникальный текст под конкретного ребёнка). И уточняем что
# иллюстраций ТРИ, не одна — в PDF они все.
_CTA_TEMPLATE = (
    "\n\n— — —\n"
    "💌 А у вас есть ребёнок, для которого хочется такую же сказку — "
    "только лично про него?\n"
    "Откройте @{bot_username} — Сказочник напишет ПЕРСОНАЛЬНУЮ сказку "
    "под вашего ребёнка: имя, возраст, любимый герой. С тремя "
    "авторскими иллюстрациями в PDF-книжке. За минуту."
)
