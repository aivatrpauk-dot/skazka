...
# ─────────────── Имена для ротации ───────────────
# CIS-имена, по которым родители узнают «своих». Не вытаскиваем из БД —
# наш контент-канал использует прокатанный надёжный список, не зависит от
# того кто там зарегился.
_NAMES_GIRLS = [
