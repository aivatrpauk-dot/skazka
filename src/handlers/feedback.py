...
FEEDBACK_INVITE_TEXT = (
    ...
    "Я хочу стать лучшим детским писателем, это моя мечта. Мне нужна "
    "Ваша критика моих работ — что и где Вам не понравилось, чего не "
    "хватило, может что-то нужно улучшить?\n\n"
