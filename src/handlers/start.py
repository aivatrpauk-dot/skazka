...
WELCOME = (
    "🕯 Здравствуйте. Это <b>{brand}</b> — здесь каждый вечер для "
    "Вашего ребёнка 3-6 лет сочиняется <b>персональная поучительная "
    "сказка на ночь, где он сам — главный герой</b>.\n\n"
    "Вы расскажете мне имя ребёнка и возраст — а наш сказочник за "
    "пару минут принесёт Вам красивую <b>PDF-книжечку</b> с тремя "
    "авторскими иллюстрациями. Открываете и читаете вслух.\n\n"
    "👩‍👧 Читаете Вы — самым тёплым голосом в мире.\n\n"
    "🌙 Одна сказка в вечер — и спокойный сон. Таков наш маленький "
    "ритуал.\n\n"
    "Первая сказка — в подарок. Когда будете готовы, приступим.\n\n"
