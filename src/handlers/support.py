...
async def cmd_support(message: Message) -> None:
    await message.answer(
        "🕯 Напишите прямо в этот чат — что случилось, и мы обязательно "
        "поможем. Поддержка прочтёт Ваше письмо в течение суток и "
        "ответит сюда же.\n\n"
        "Возможно, ответ уже ждёт Вас в нашей <b>Помощи</b> — "
        "загляните туда, часто это быстрее."
    )
